...
После деплоя откройте сайт с параметром `_ym_debug=2`, разрешите аналитику
и проверьте вкладки Counters / Events отладчика Яндекс Метрики.

В консоли браузера можно вызвать:

sdelatVychetAnalyticsStatus()
...
В 2.4.1 исправлена отправка:
- analysis_success
- payment_success
- report_view

Query-параметры страницы (включая analysis/payment/paid) в Метрику не отправляются.
